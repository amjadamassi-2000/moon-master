...
class CoffeeHomeTabPageNotifiers with ChangeNotifier {
  // ||....................... notifiable ..................................||
...
//--------------------------------------------------------------------------------------------------//
  ...
  // ||... constructor ...||
  CoffeeHomeTabPageNotifiers(this.context) {
  ...
  void init(bool isInit) async {
    ...
    productsResponse = await _productsController.getProducts(
        AppShared
            .settingResponse.settings.coffeeCategory[selectedCategory].id,
        page);
...
//    }
  ...
  void getProducts() async {
    if (page == 1) {
      ...
      isProductsLoading = true;
      productsResponse = await _productsController.getProducts(
          AppShared.settingResponse.settings.coffeeCategory[selectedCategory].id,
          page);
      isProductsLoading = false;
      //  }
//      catch (error) {
...
//            MessageType.MESSAGE_FAILED);
      ...
      ProductsResponse response = await _productsController.getProducts(
          AppShared
              .settingResponse.settings.coffeeCategory[selectedCategory].id,
          page);
