...
class CoffeeProductDetailsScreenNotifiers with ChangeNotifier {
  // ||....................... notifiable ..................................||
...
//--------------------------------------------------------------------------------------------------//
  ...
  // ||... constructor ...||
  CoffeeProductDetailsScreenNotifiers(this.context) {
...
// add product to cart.
  ...
  void getProductDetails(int productId) async {
    try {
      productDetailsResponse = await productsController.getProductDetails(productId: productId);
