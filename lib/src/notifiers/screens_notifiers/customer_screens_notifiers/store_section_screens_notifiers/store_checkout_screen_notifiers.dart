...
class StoreCheckoutScreenNotifiers with ChangeNotifier {
  // ||....................... notifiable ..................................||
...
//--------------------------------------------------------------------------------------------------//
  ...
  // ||... constructor ...||
  StoreCheckoutScreenNotifiers(this.context, this.products) {
    ...
    deliveryTimeTextEditingController.text =
        Helpers.formatTime(TimeOfDay.now());
    calculate();
  }
      ...
      if (coffeeCheckoutResponse.status) {
        if (coffeeCheckoutResponse.link == null) {
          ...
          Navigator.pushNamedAndRemoveUntil(
              context, Constants.SCREENS_STORE_MAIN_SCREEN, (route) => false);
        } else {
