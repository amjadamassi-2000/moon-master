...
class StoreHomeTabPageNotifiers with ChangeNotifier {
  // ||....................... notifiable ..................................||
...
//--------------------------------------------------------------------------------------------------//
  ...
  // ||... constructor ...||
  StoreHomeTabPageNotifiers(this.context) {
  ...
  void init(bool isInit) async {
    //try {
      ...
      productsResponse = await productsController.getProducts(
          AppShared.settingResponse.settings.salonCategory[selectedCategory].id,
          page);
  ...
  void getStoreProducts() async {
    if (page == 1) {
      try {
        ...
        productsResponse = await productsController.getProducts(
            AppShared
                .settingResponse.settings.salonCategory[selectedCategory].id,
            page);
        isProductsLoading = false;
      } catch (error) {
        isError = true;
