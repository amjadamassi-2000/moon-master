...
class DriverOrdersPageNotifiers with ChangeNotifier {
  // ||....................... notifiable ..................................||
...
//--------------------------------------------------------------------------------------------------//
  ...
  // ||... constructor ...||
  DriverOrdersPageNotifiers(this.context) {
  ...
  Future getOrders({bool isInit = true}) async {
    if (page == 1) {
      try {
        ...
        ordersResponse = await ordersController.getOrdersForDriver();
        isLoading = false;
      ...
      //try {
        ...
        OrdersResponse response =
            await ordersController.getOrdersForDriver(page: page);
...
//      }
  ...
  // change status.
  void changeStatus(int orderId, int status) async {
    //try {
      BaseResponse baseResponse =
          await ordersController.changeOrderStatus(orderId, status);
      isLoading = false;
