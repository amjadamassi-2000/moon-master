...
class BeautyNavDrawerComponent extends StatelessWidget {
  final BeautyMainScreenNotifiers _beautyMainScreenNotifiers;
  final ZoomDrawerController _zoomDrawerController;

  BeautyNavDrawerComponent(
      this._beautyMainScreenNotifiers, this._zoomDrawerController);

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<BeautyMainScreenNotifiers>(
        create: (_) => BeautyMainScreenNotifiers(),
        child: BeautyNavDrawerComponentBody(
            _beautyMainScreenNotifiers, _zoomDrawerController));
  }
}

class BeautyNavDrawerComponentBody extends StatefulWidget {
  final BeautyMainScreenNotifiers _beautyMainScreenNotifiers;
  final ZoomDrawerController _zoomDrawerController;

  BeautyNavDrawerComponentBody(
      this._beautyMainScreenNotifiers, this._zoomDrawerController);
  @override
  _BeautyNavDrawerComponentBodyState createState() =>
      _BeautyNavDrawerComponentBodyState();
}

class _BeautyNavDrawerComponentBodyState
    extends State<BeautyNavDrawerComponentBody> {
  ...
  Widget listTileLeading(int index) {
    return Container(
      width: 5,
      height: 30,
      color: widget._beautyMainScreenNotifiers.selectedIndex == index
            ...
            children: <Widget>[
              ...
              ListView(
                ...
                children: <Widget>[
                  ListTile(
                    onTap: () {
                      widget._beautyMainScreenNotifiers.selectedIndex = 0;
                  ...
                  ListTile(
                    onTap: () {
                      ...
                      widget._beautyMainScreenNotifiers.selectedIndex = 1;
                      widget._zoomDrawerController.close();
                    },
                  ...
                  ListTile(
                    onTap: () {
                      ...
                      widget._beautyMainScreenNotifiers.selectedIndex = 2;
                      widget._zoomDrawerController.close();
                    },
                  ...
                  ListTile(
                    onTap: () {
                      widget._beautyMainScreenNotifiers.selectedIndex = 3;
                      widget._zoomDrawerController.close();
                    },
...
//                    ListTile(
//                      onTap: () {
//                        widget._beautyMainScreenNotifiers.selectedIndex = 4;
//                        widget._zoomDrawerController.close();
//                      },
//                      title: Text(AppShared.appLang['Offers']),
//                      leading: listTileLeading(4),
//                    ),
                  ListTile(
                    onTap: () {
                      widget._beautyMainScreenNotifiers.selectedIndex = 5;
                      widget._zoomDrawerController.close();
                    },
                  ...
                  ListTile(
                    onTap: () {
                      widget._beautyMainScreenNotifiers.selectedIndex = 6;
                      widget._zoomDrawerController.close();
                    },
                  ...
                  ListTile(
                    onTap: () {
                      widget._beautyMainScreenNotifiers.selectedIndex = 7;
                      widget._zoomDrawerController.close();
                    },
                  ...
                  ListTile(
                    onTap: () {
                      widget._beautyMainScreenNotifiers.selectedIndex = 8;
                      widget._zoomDrawerController.close();
                    },
