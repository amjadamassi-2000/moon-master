...
class CoffeeFilterSecondScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return ParentComponent(
      child: CoffeeFilterSecondScreenBody(),
    );
  }
}

class CoffeeFilterSecondScreenBody extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return CoffeeFilterSecondScreenBodyState();
  }
}

class CoffeeFilterSecondScreenBodyState
    extends State<CoffeeFilterSecondScreenBody> {
