...
class StoreFilterScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return ParentComponent(
      child: StoreFilterScreenBody(),
    );
  }
}

class StoreFilterScreenBody extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _StoreFilterScreenBodyState();
  }
}

class _StoreFilterScreenBodyState extends State<StoreFilterScreenBody> {
