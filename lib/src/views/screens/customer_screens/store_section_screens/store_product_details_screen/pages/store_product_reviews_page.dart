...
class StoreProductReviewsPage extends StatefulWidget {
  StoreProductReviewsPage();

  @override
  _StoreProductReviewsPageState createState() =>
      _StoreProductReviewsPageState();
}

class _StoreProductReviewsPageState extends State<StoreProductReviewsPage> {
  Product _product;
  ...
  void initState() {
    ...
    _storeProductDetailsScreenNotifiers = Provider.of<StoreProductDetailsScreenNotifiers>(context, listen: false);
  }
...
//                    )
                ...
                : _storeProductDetailsScreenNotifiers
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (_, index) => ReviewComponent(
                          by: _storeProductDetailsScreenNotifiers
                              .productDetailsResponse
                              .reviews
                              .data[index]
                              .user
                              .name,
                          content: _storeProductDetailsScreenNotifiers
                              .productDetailsResponse
                              .reviews
                              .data[index]
                              .comment,
                          date: _storeProductDetailsScreenNotifiers
                              .productDetailsResponse
                              .reviews
                              .data[index]
                              .createdAt,
                          rating: _storeProductDetailsScreenNotifiers
          ...
          _storeProductDetailsScreenNotifiers.productDetailsResponse!=null && _storeProductDetailsScreenNotifiers.productDetailsResponse.reviews.data.isNotEmpty
              ? InkWell(
            onTap: () {
              Navigator.pushNamed(
                        ...
                        children: <Widget>[
                          ...
                          RatingBar.builder(
                            onRatingUpdate: (rating) {
                              _storeProductDetailsScreenNotifiers.rate = rating;
                            },
                            initialRating: 0,
                            minRating: 1,
                          ...
                          Form(
                            key: _storeProductDetailsScreenNotifiers
                                .rateFromState,
                            child: TextFormField(
                              maxLines: 3,
                              ...
                              onSaved: (value) {
                                _storeProductDetailsScreenNotifiers.comment =
                                    value;
                              },
                            ),
                          ),
